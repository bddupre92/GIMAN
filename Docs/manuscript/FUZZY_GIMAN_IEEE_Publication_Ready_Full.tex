...
\input{../audit/ieee_tables/table_internal_metrics.tex}
...
\input{../audit/ieee_tables/table_calibration.tex}
...
\input{../audit/ieee_tables/table_cycle_gates.tex}
...
Run-tagged external evaluation (EV_20260207_PPMI_20250930_PRELIM) was executed under the frozen contract and checkpoint registry.
\begin{itemize}
\item Cohort size: 90, positives: 16
\item AUC: 0.590 (95\% CI [0.463, 0.725])
\item PR-AUC: 0.285 (95\% CI [0.144, 0.483])
\item Raw calibration ECE/Brier: 0.392 / 0.292
\end{itemize}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../../visualizations/publication_ieee_external/PPMI_20250930_PRELIM/phase3_internal_vs_external_panel.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../../visualizations/publication_ieee_external/PPMI_20250930_PRELIM/phase3_transportability_gap.png}
\caption{Transportability gap diagnostics for external validation.}
\label{fig:transportability_gap}
\end{figure}

\input{../audit/EXTERNAL_VALIDATION_TABLES_EV_20260207_PPMI_20250930_PRELIM.tex}
