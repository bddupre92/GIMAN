...
| [`github_inventory.md`](../../outputs/paper12_scoping/github_inventory.md) | **Phase 2** — 18 repos scored for licensing + maintenance + PyTorch compat. Identifies vendor-direct candidates (de Rooij MIT) vs clean-room targets (CNODE, Demirkaya, Zou, LagCNN). |
