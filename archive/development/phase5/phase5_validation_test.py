...
def test_phase5_imports():
    ...
    try:
        ...
        from phase5_dynamic_loss_system import (
            DynamicLossGIMANSystem,
            DynamicLossWeighter,
        )
...
def test_model_instantiation():
    ...
    try:
        ...
        _task_model = TaskSpecificGIMANSystem(
            spatial_dim=256,
            genomic_dim=8,
            temporal_dim=64,
            hidden_dim=64,
        ...
        logger.info("   ✅ Task-specific model instantiation successful")

        # Test dynamic loss model
        _dynamic_model = DynamicLossGIMANSystem(
            loss_strategy="fixed",
            spatial_dim=256,
            genomic_dim=8,
            temporal_dim=64,
        ...
        logger.info("   ✅ Dynamic loss model instantiation successful")

        # Test loss weighter
        _weighter = DynamicLossWeighter(strategy="adaptive")
...
def test_forward_pass():
    ...
    try:
        ...
        logger.info(
            f"   ✅ Task-specific forward pass: motor={motor_pred1.shape}, cognitive={cognitive_pred1.shape}"
        )
        ...
        logger.info(
            f"   ✅ Dynamic loss forward pass: motor={motor_pred2.shape}, cognitive={cognitive_pred2.shape}"
        )
...
def test_loss_weighting():
    ...
    try:
        ...
        for strategy in strategies:
            ...
            logger.info(
                f"   ✅ {strategy.upper()}: motor={motor_weight:.3f}, cognitive={cognitive_weight:.3f}"
            )
