...
\raggedright\scriptsize\textit{Note:} Totals per domain shown in parentheses. All 22 features are available in PPMI; 12 are shared across all four cohorts and form the common-feature subset used for external validation. CatBoost drops UPDRS4\_TOTAL and MOCA\_TOTAL at model-fit time because of ${>}80\%$ missingness, seeing 20 features after this filter. A 33-feature sensitivity variant adding 11 further PPMI features (cortical thickness, CSF biomarkers, polygenic risk score) is reported in Supplementary~S-3.
\end{table*}
...
\multirow{4}{*}{\textbf{Binary}}
 ...
 & Multimodal GAT (2-mod, 22-feat) & 0.825 $\pm$ 0.013 & 0.894 & $-$0.126 \\
 & Simple GAT & 0.832 $\pm$ 0.019 & 0.927 & $-$0.119 \\
 & Multimodal GAT (3-mod, 32-feat) & 0.934 $\pm$ 0.011 & 0.978 & $-$0.017 \\
\midrule
\multirow{4}{*}{\textbf{Three-class}}
 & CatBoost (tabular) & \textbf{0.783} & 0.944 & --- \\
 & Multimodal GAT (2-mod, 22-feat) & 0.705 $\pm$ 0.033 & 0.873 & $-$0.073 \\
 & Simple GAT & 0.666 $\pm$ 0.031 & 0.873 & $-$0.112 \\
 & Multimodal GAT (3-mod, 32-feat) & 0.753 $\pm$ 0.018 & 0.924 & $-$0.030 \\
\midrule
\multirow{4}{*}{\textbf{Full ordinal}}
 & CatBoost (tabular) & \textbf{0.658} & 0.954 & --- \\
 & Multimodal GAT (2-mod, 22-feat) & 0.549 $\pm$ 0.044 & 0.858 & $-$0.109 \\
 & Simple GAT & 0.521 $\pm$ 0.090 & 0.844 & $-$0.137 \\
 & Multimodal GAT (3-mod, 32-feat) & 0.502 $\pm$ 0.097 & 0.860 & $-$0.156 \\
\midrule
\multirow{4}{*}{\textbf{NSD+}}
 & CatBoost (tabular) & \textbf{0.671} & 0.913 & --- \\
 & Multimodal GAT (2-mod, 22-feat) & 0.544 $\pm$ 0.060 & 0.769 & $-$0.127 \\
 & Simple GAT & 0.493 $\pm$ 0.029 & 0.736 & $-$0.178 \\
 & Multimodal GAT (3-mod, 32-feat) & 0.417 $\pm$ 0.104 & 0.697 & $-$0.254 \\
\bottomrule
\end{tabular}
\vspace{2pt}
