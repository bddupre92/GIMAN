...
\midrule
DeepHit  & LRRK2+              & TBD & TBD & 0.236 & TBD & 0.372 \\
DeepHit  & GBA+~only           & TBD & TBD & 0.355 & TBD & 0.426 \\
DeepHit  & APOE~$\varepsilon4$+~only & TBD & TBD & 0.683 & TBD & 0.683 \\
Graph-DT & LRRK2+              & TBD & TBD & 0.163 & TBD & 0.372 \\
Graph-DT & GBA+~only           & TBD & TBD & 0.049 & TBD & 0.295 \\
Graph-DT & APOE~$\varepsilon4$+~only & TBD & TBD & 0.248 & TBD & 0.372 \\
\bottomrule
\end{tabular}
\end{table}

\noindent\textbf{Verdict.} The post-WS-P3-CRIT-B FDR-corrected pooled-OOF $p$-values are reported in column $p_\mathrm{FDR,pooled}$ (post-fix). The H2 PASS verdict from the original analysis -- no significant model$\times$subgroup interactions after BH--FDR correction -- is preserved iff every pooled $p_\mathrm{FDR}$ exceeds the pre-registered $\alpha{=}0.05$ threshold; the §S-CRIT-B audit table below reports the change for each cell. The legacy Fisher pipeline produced a marginal Graph-DT $\times$ GBA+~only $p_\mathrm{Fisher}{=}0.049$ (which did not survive FDR correction); the pooled-OOF re-test characterises whether this borderline cell was genuine signal or a multiple-comparison artifact amplified by the per-fold positive dependence.
...
\midrule
DeepHit  & LRRK2+              & 0.236 & TBD & 0.372 & TBD \\
DeepHit  & GBA+~only           & 0.355 & TBD & 0.426 & TBD \\
DeepHit  & APOE~$\varepsilon4$+~only & 0.683 & TBD & 0.683 & TBD \\
Graph-DT & LRRK2+              & 0.163 & TBD & 0.372 & TBD \\
Graph-DT & GBA+~only           & 0.049 & TBD & 0.295 & TBD \\
Graph-DT & APOE~$\varepsilon4$+~only & 0.248 & TBD & 0.372 & TBD \\
\bottomrule
\end{tabular}
\end{table}
