...
\bibitem{dupre2026paper1} B.\,D.~Dupre, ``NSD-ISS Biological Stage Prediction with Calibrated Uncertainty,'' 2026 (submitted to \textit{IEEE J.\ Biomed.\ Health Inform.}).

\bibitem{dupre2026paper4} B.\,D.~Dupre, ``Conformalized Survival Analysis for NSD-ISS Stage Transitions in Parkinson's Disease,'' 2026 (submitted to \textit{npj Digit.\ Med.}; combined with Paper~3).

\bibitem{dupre2026paper5} B.\,D.~Dupre, ``Temporal Validation and Deployment Readiness for NSD-ISS Stage-Transition Prediction,'' 2026 (submitted to \textit{J.\ Am.\ Med.\ Inform.\ Assoc.}).
...
\bibitem{dupre2026paper8a} B.\,D.~Dupre, ``Practical Identifiability Limits of Spatial Propagation Parameters in Mechanistic Parkinson's Disease Digital Twins,'' 2026 (submitted to \textit{PLoS Comput.\ Biol.}).
