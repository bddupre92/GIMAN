# Multi-Observable SAEM (multi_obs_v3_gfap_with) — Run Manifest
...
**Run timestamp (UTC):** 2026-04-16T14:56:47.265658+00:00
...
```json
{
  "seed": 20260415,
  "N_IS": 50000,
  "run_tag": "multi_obs_v3_gfap_with"
}
```
...
- **n_patients:** 357
- **log_kn_sd_prior_ratio:** 0.01291099238245276
- **cor_logk_loga:** -0.0356518614037496
- **pct_yr_median:** 9.318060741000389
