# Multi-Observable SAEM (multi_obs_v3_dryrun) — Run Manifest
...
**Run timestamp (UTC):** 2026-04-16T04:09:06.869581+00:00
...
```
scripts/mechanistic_twin/ch9_6_run_saem_v3.py --subset 50 --n-iterations 20 --n-burn 10 --run-tag multi_obs_v3_dryrun
```
...
- **n_patients:** 50
- **log_kn_sd_prior_ratio:** 0.014527558366968342
- **cor_logk_loga:** -0.021021472760723504
- **pct_yr_median:** 5.571884804358285
