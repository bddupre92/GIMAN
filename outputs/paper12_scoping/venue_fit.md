...
2a. **de Rooij et al. 2025 PLOS Comp Biol** (DOI 10.1371/journal.pcbi.1012198) — "Physiology-informed regularisation enables training of universal differential equation systems for biological applications." THE closest methodological prior for phys-GIMIN's lit variant per `novelty_verdict.md` (2026-04-19 correction). Cite in Section II as both motivation (non-negativity + AUC penalties are the immediate precedent for phys-GIMIN's β-NLL physics regulariser) and in Section V as the #1 competitor with vendorable CC-BY code. [JSONL: `derooij2025ude`]
