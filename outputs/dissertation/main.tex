...
% CUSTOM MACROS
% =============================================================================
% Paper 9 (PK/PD) macros — dopamine, levodopa-equivalent dose, neuron fraction
\newcommand{\DA}{\mathrm{DA}}
\newcommand{\LEDD}{\mathrm{LEDD}}
\newcommand{\Nfrac}{N_{\mathrm{frac}}}

% Common LaTeX abbreviation shortcuts (used across Papers 7-10)
...
\input{chapters/ch02_systematic_review}
\input{chapters/ch03_paper1}
\input{chapters/ch04_paper2}
\input{chapters/ch05_paper3}
\input{chapters/ch06_paper4}
\input{chapters/ch07_paper5}
\input{chapters/ch08_paper6}
\input{chapters/ch09_paper7}
\input{chapters/ch10_paper8a}
\input{chapters/ch11_paper8b}
\input{chapters/ch12_paper9}
\input{chapters/ch13_paper10}
\input{chapters/ch14_discussion}
\input{chapters/ch16_paper11_preview}
...
\input{chapters/mechtwin_review}
